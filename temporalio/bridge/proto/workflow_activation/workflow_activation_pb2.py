...
_DELIVERSTREAMMESSAGES = DESCRIPTOR.message_types_by_name['DeliverStreamMessages']
_INITIALIZEWORKFLOW = DESCRIPTOR.message_types_by_name['InitializeWorkflow']
_INITIALIZEWORKFLOW_HEADERSENTRY = _INITIALIZEWORKFLOW.nested_types_by_name['HeadersEntry']
_FIRETIMER = DESCRIPTOR.message_types_by_name['FireTimer']
_RESOLVEACTIVITY = DESCRIPTOR.message_types_by_name['ResolveActivity']
_RESOLVECHILDWORKFLOWEXECUTIONSTART = DESCRIPTOR.message_types_by_name['ResolveChildWorkflowExecutionStart']
_RESOLVECHILDWORKFLOWEXECUTIONSTARTSUCCESS = DESCRIPTOR.message_types_by_name['ResolveChildWorkflowExecutionStartSuccess']
_RESOLVECHILDWORKFLOWEXECUTIONSTARTFAILURE = DESCRIPTOR.message_types_by_name['ResolveChildWorkflowExecutionStartFailure']
...
_RESOLVESIGNALEXTERNALWORKFLOW = DESCRIPTOR.message_types_by_name['ResolveSignalExternalWorkflow']
_RESOLVEREQUESTCANCELEXTERNALWORKFLOW = DESCRIPTOR.message_types_by_name['ResolveRequestCancelExternalWorkflow']
_DOUPDATE = DESCRIPTOR.message_types_by_name['DoUpdate']
_DOUPDATE_HEADERSENTRY = _DOUPDATE.nested_types_by_name['HeadersEntry']
_RESOLVENEXUSOPERATIONSTART = DESCRIPTOR.message_types_by_name['ResolveNexusOperationStart']
...
WorkflowActivation = _reflection.GeneratedProtocolMessageType('WorkflowActivation', (_message.Message,), {
...
WorkflowActivationJob = _reflection.GeneratedProtocolMessageType('WorkflowActivationJob', (_message.Message,), {
...
DeliverStreamMessages = _reflection.GeneratedProtocolMessageType('DeliverStreamMessages', (_message.Message,), {
  'DESCRIPTOR' : _DELIVERSTREAMMESSAGES,
  '__module__' : 'temporal.sdk.core.workflow_activation.workflow_activation_pb2'
  # @@protoc_insertion_point(class_scope:coresdk.workflow_activation.DeliverStreamMessages)
  })
_sym_db.RegisterMessage(DeliverStreamMessages)

InitializeWorkflow = _reflection.GeneratedProtocolMessageType('InitializeWorkflow', (_message.Message,), {
...
FireTimer = _reflection.GeneratedProtocolMessageType('FireTimer', (_message.Message,), {
...
ResolveActivity = _reflection.GeneratedProtocolMessageType('ResolveActivity', (_message.Message,), {
...
ResolveChildWorkflowExecutionStart = _reflection.GeneratedProtocolMessageType('ResolveChildWorkflowExecutionStart', (_message.Message,), {
...
ResolveChildWorkflowExecutionStartSuccess = _reflection.GeneratedProtocolMessageType('ResolveChildWorkflowExecutionStartSuccess', (_message.Message,), {
...
ResolveChildWorkflowExecutionStartFailure = _reflection.GeneratedProtocolMessageType('ResolveChildWorkflowExecutionStartFailure', (_message.Message,), {
...
ResolveChildWorkflowExecutionStartCancelled = _reflection.GeneratedProtocolMessageType('ResolveChildWorkflowExecutionStartCancelled', (_message.Message,), {
...
ResolveChildWorkflowExecution = _reflection.GeneratedProtocolMessageType('ResolveChildWorkflowExecution', (_message.Message,), {
...
UpdateRandomSeed = _reflection.GeneratedProtocolMessageType('UpdateRandomSeed', (_message.Message,), {
...
QueryWorkflow = _reflection.GeneratedProtocolMessageType('QueryWorkflow', (_message.Message,), {
...
CancelWorkflow = _reflection.GeneratedProtocolMessageType('CancelWorkflow', (_message.Message,), {
...
SignalWorkflow = _reflection.GeneratedProtocolMessageType('SignalWorkflow', (_message.Message,), {
...
NotifyHasPatch = _reflection.GeneratedProtocolMessageType('NotifyHasPatch', (_message.Message,), {
...
ResolveSignalExternalWorkflow = _reflection.GeneratedProtocolMessageType('ResolveSignalExternalWorkflow', (_message.Message,), {
...
ResolveRequestCancelExternalWorkflow = _reflection.GeneratedProtocolMessageType('ResolveRequestCancelExternalWorkflow', (_message.Message,), {
...
DoUpdate = _reflection.GeneratedProtocolMessageType('DoUpdate', (_message.Message,), {
...
ResolveNexusOperationStart = _reflection.GeneratedProtocolMessageType('ResolveNexusOperationStart', (_message.Message,), {
...
ResolveNexusOperation = _reflection.GeneratedProtocolMessageType('ResolveNexusOperation', (_message.Message,), {
...
RemoveFromCache = _reflection.GeneratedProtocolMessageType('RemoveFromCache', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\352\0025Temporalio::Internal::Bridge::Api::WorkflowActivation'
  ...
  _WORKFLOWACTIVATION._serialized_start=570
  _WORKFLOWACTIVATION._serialized_end=1116
  _WORKFLOWACTIVATIONJOB._serialized_start=1119
  _WORKFLOWACTIVATIONJOB._serialized_end=2582
  _DELIVERSTREAMMESSAGES._serialized_start=2585
  _DELIVERSTREAMMESSAGES._serialized_end=2724
  _INITIALIZEWORKFLOW._serialized_start=2727
  _INITIALIZEWORKFLOW._serialized_end=4131
  _INITIALIZEWORKFLOW_HEADERSENTRY._serialized_start=4052
  _INITIALIZEWORKFLOW_HEADERSENTRY._serialized_end=4131
  _FIRETIMER._serialized_start=4133
  _FIRETIMER._serialized_end=4157
  _RESOLVEACTIVITY._serialized_start=4159
  _RESOLVEACTIVITY._serialized_end=4268
  _RESOLVECHILDWORKFLOWEXECUTIONSTART._serialized_start=4271
  _RESOLVECHILDWORKFLOWEXECUTIONSTART._serialized_end=4608
  _RESOLVECHILDWORKFLOWEXECUTIONSTARTSUCCESS._serialized_start=4610
  _RESOLVECHILDWORKFLOWEXECUTIONSTARTSUCCESS._serialized_end=4669
  _RESOLVECHILDWORKFLOWEXECUTIONSTARTFAILURE._serialized_start=4672
  _RESOLVECHILDWORKFLOWEXECUTIONSTARTFAILURE._serialized_end=4838
  _RESOLVECHILDWORKFLOWEXECUTIONSTARTCANCELLED._serialized_start=4840
  _RESOLVECHILDWORKFLOWEXECUTIONSTARTCANCELLED._serialized_end=4936
  _RESOLVECHILDWORKFLOWEXECUTION._serialized_start=4938
  _RESOLVECHILDWORKFLOWEXECUTION._serialized_end=5043
  _UPDATERANDOMSEED._serialized_start=5045
  _UPDATERANDOMSEED._serialized_end=5088
  _QUERYWORKFLOW._serialized_start=5091
  _QUERYWORKFLOW._serialized_end=5351
  _QUERYWORKFLOW_HEADERSENTRY._serialized_start=4052
  _QUERYWORKFLOW_HEADERSENTRY._serialized_end=4131
  _CANCELWORKFLOW._serialized_start=5353
  _CANCELWORKFLOW._serialized_end=5385
  _SIGNALWORKFLOW._serialized_start=5388
  _SIGNALWORKFLOW._serialized_end=5677
  _SIGNALWORKFLOW_HEADERSENTRY._serialized_start=4052
  _SIGNALWORKFLOW_HEADERSENTRY._serialized_end=4131
  _NOTIFYHASPATCH._serialized_start=5679
  _NOTIFYHASPATCH._serialized_end=5713
  _RESOLVESIGNALEXTERNALWORKFLOW._serialized_start=5715
  _RESOLVESIGNALEXTERNALWORKFLOW._serialized_end=5810
  _RESOLVEREQUESTCANCELEXTERNALWORKFLOW._serialized_start=5812
  _RESOLVEREQUESTCANCELEXTERNALWORKFLOW._serialized_end=5914
  _DOUPDATE._serialized_start=5917
  _DOUPDATE._serialized_end=6248
  _DOUPDATE_HEADERSENTRY._serialized_start=4052
  _DOUPDATE_HEADERSENTRY._serialized_end=4131
  _RESOLVENEXUSOPERATIONSTART._serialized_start=6251
  _RESOLVENEXUSOPERATIONSTART._serialized_end=6405
  _RESOLVENEXUSOPERATION._serialized_start=6407
  _RESOLVENEXUSOPERATION._serialized_end=6496
  _REMOVEFROMCACHE._serialized_start=6499
  _REMOVEFROMCACHE._serialized_end=6851
  _REMOVEFROMCACHE_EVICTIONREASON._serialized_start=6613
  _REMOVEFROMCACHE_EVICTIONREASON._serialized_end=6851
