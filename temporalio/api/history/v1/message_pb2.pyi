...
class WorkflowExecutionStartedEventAttributes(google.protobuf.message.Message):
    ...
    def time_skipping_state_propagation(
        self,
    ) -> temporalio.api.common.v1.message_pb2.TimeSkippingStatePropagation:
...
class WorkflowTaskCompletedEventAttributes(google.protobuf.message.Message):
    ...
    DEPLOYMENT_VERSION_FIELD_NUMBER: builtins.int
    STREAM_CURSORS_FIELD_NUMBER: builtins.int
    scheduled_event_id: builtins.int
    """The id of the `WORKFLOW_TASK_SCHEDULED` event this task corresponds to"""
    ...
    def stream_cursors(
        ...
        temporalio.api.stream.v1.message_pb2.StreamCursor
    ]:
        """The offsets this task consumed, without the payloads. Recorded so replay
        can reproduce what the task saw, including a range that was empty.
        """
    def __init__(
        self,
        *,
        ...
        deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion
        | None = ...,
        stream_cursors: collections.abc.Iterable[
            temporalio.api.stream.v1.message_pb2.StreamCursor
        ]
        | None = ...,
    ) -> None: ...
...
class WorkflowExecutionOptionsUpdatedEventAttributes(google.protobuf.message.Message):
    ...
    PRIORITY_FIELD_NUMBER: builtins.int
    TIME_SKIPPING_CONFIG_FIELD_NUMBER: builtins.int
    TIME_SKIPPING_CONFIG_UPDATED_FIELD_NUMBER: builtins.int
    ...
    time_skipping_config_updated: builtins.bool
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"time_skipping_config_updated",
...
class WorkflowStreamMessagesAddedEventAttributes(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___WorkflowStreamMessagesAddedEventAttributes = (
...
class WorkflowStreamSubscribedEventAttributes(google.protobuf.message.Message):
    ...
    """Resolved by the server when the subscription is registered, so replay
    reads the resolved value rather than resolving it again.
    """
    def __init__(
        self,
        *,
...
class WorkflowExecutionPausedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "identity", b"identity", "reason", b"reason", "request_id", b"request_id"
        ],
    ) -> None: ...

global___WorkflowExecutionPausedEventAttributes = WorkflowExecutionPausedEventAttributes

class WorkflowExecutionUnpausedEventAttributes(google.protobuf.message.Message):
...
class WorkflowExecutionTimeSkippingTransitionedEventAttributes(
    ...
    DISABLED_AFTER_FAST_FORWARD_FIELD_NUMBER: builtins.int
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "disabled_after_fast_forward",
            b"disabled_after_fast_forward",
            "target_time",
            b"target_time",
            "wall_clock_time",
            b"wall_clock_time",
...
class HistoryEvent(google.protobuf.message.Message):
    ...
    WORKFLOW_STREAM_MESSAGES_ADDED_EVENT_ATTRIBUTES_FIELD_NUMBER: builtins.int
    ...
    def workflow_execution_paused_event_attributes(
        self,
    ) -> global___WorkflowExecutionPausedEventAttributes: ...
    @property
    ...
    @property
    def workflow_stream_messages_added_event_attributes(
        self,
    ) -> global___WorkflowStreamMessagesAddedEventAttributes: ...
    def __init__(
        self,
        *,
        ...
        | None = ...,
        workflow_execution_paused_event_attributes: global___WorkflowExecutionPausedEventAttributes
        | None = ...,
        ...
        | None = ...,
        workflow_stream_messages_added_event_attributes: global___WorkflowStreamMessagesAddedEventAttributes
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            ...
            b"workflow_execution_paused_event_attributes",
            ...
            b"workflow_execution_unpaused_event_attributes",
            ...
            "workflow_stream_messages_added_event_attributes",
            b"workflow_stream_messages_added_event_attributes",
