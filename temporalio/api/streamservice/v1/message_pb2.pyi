...
class StreamMessage(_message.Message):
    ...
    def __init__(
        self,
        body: _Optional[_Union[_message_pb2.Payload, _Mapping]] = ...,
        metadata: _Optional[_Mapping[str, _message_pb2.Payload]] = ...,
        topic: _Optional[str] = ...,
        topic_sequence: _Optional[int] = ...,
        kind: _Optional[_Union[StreamMessageKind, str]] = ...,
...
class StreamMessageBatch(_message.Message):
    ...
    def __init__(
        self, messages: _Optional[_Iterable[_Union[StreamMessage, _Mapping]]] = ...
    ) -> None: ...
